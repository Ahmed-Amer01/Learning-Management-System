...
public class NotificationService {
    ...
    void markNotificationAsRead(Long notificationID) {
        ...
        Notification newN = new Notification(target.notificationID(), target.notificationType(), target.receiverType(), target.receiversIDs(), target.message(), target.createdAt(), true);
